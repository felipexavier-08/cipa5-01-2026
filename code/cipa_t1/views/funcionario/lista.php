        ...
        <tbody>
            <?php if (!empty($funcionarios) && is_array($funcionarios)): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/code/cipa_t1/funcionario/deletar?id=<?php echo $f->getIdFuncionario(); ?>">Deletar</a>
                    </td> 
                     <td>
                        <a href="/code/cipa_t1/funcionario/editar?id=<?php echo $f->getIdFuncionario(); ?>">Editar</a>
                    </td> 
                </tr>
                <?php endforeach; ?>
            <?php else: ?>
